...
def article(request,id):
	...
	return render_to_response('blog_article.html',{'text_title':json.dumps(text_title),'text_content':json.dumps(text_content),'text_tag':json.dumps(text_tag),"text_time":text.create_time})
